...
@Operation(summary = Constants.POKEMON_TYPEONE_AND_TYPETWO_SUMMARRY, description = Constants.POKEMON_TYPEONE_AND_TYPETWO_DESCRIPTION,security = @SecurityRequirement(name = "bearerAuth"))
