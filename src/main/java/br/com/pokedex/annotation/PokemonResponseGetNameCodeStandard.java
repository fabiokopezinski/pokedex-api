...
@Operation(summary = Constants.POKEMON_NAME_SUMMARRY, description = Constants.POKEMON_NAME_DESCRIPTION,security = @SecurityRequirement(name = "bearerAuth"))
public @interface PokemonResponseGetNameCodeStandard {
