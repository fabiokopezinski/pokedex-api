...
@ApiResponses(value = {
		...
		@ApiResponse(responseCode = "400", description = "Não possui cadastro",content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,schema = @Schema(implementation = BusinessExceptionBody.class))),
