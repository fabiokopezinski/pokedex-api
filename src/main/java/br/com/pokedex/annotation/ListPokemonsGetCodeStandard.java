...
@ApiResponses(value = {
		@ApiResponse(responseCode = "200", description = "Retorna os associados existentes", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,schema = @Schema(implementation = PokemonResponse.class))),
