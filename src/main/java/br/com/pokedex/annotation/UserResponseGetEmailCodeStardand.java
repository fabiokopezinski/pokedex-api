...
@Operation(summary = Constants.USER_SEARCH_EMAIL_SUMMARRY, description = Constants.USER_SEARCH_EMAIL_DESCRIPTION,security = @SecurityRequirement(name = "bearerAuth"))
public @interface UserResponseGetEmailCodeStardand {
