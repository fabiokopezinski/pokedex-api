...
@Operation(summary = Constants.POKEMON_TYPEONE_SUMMARRY, description = Constants.POKEMON_TYPEONE_DESCRIPTION,security = @SecurityRequirement(name = "bearerAuth"))
public @interface PokemonResponseGetByTypeOneCodeStandard {
