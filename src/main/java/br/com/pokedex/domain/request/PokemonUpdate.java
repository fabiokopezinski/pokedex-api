...
public class PokemonUpdate {
	...
	private String name;
	@Size(min=1,max=255,message="O campo 'typeOne' no corpo da requisição está errado")
	private String  typeOne;
	@Size(min=1,max=255,message="O campo 'typeTwo' no corpo da requisição está errado")
