...
public class JwtTokenProvider implements Serializable{
   ...
   @Value("${api.jwt.secret}")
	...
	public String createToken(String username, List<String> roles) {
		...
		Date now = new Date();
		Date validity = new Date(now.getTime() + Long.valueOf(expiration));
	...
	public boolean validateToken(String token) {
		try {
            ...
            throw new InvalidJwtAuthenticationException(HttpStatus.BAD_REQUEST,Message.TOKEN_ERROR.getDescription(),null,null);		}
	}
